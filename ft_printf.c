...
/*   Updated: 2022/03/26 08:28:01 by danierod         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "libft.h"

static int	ft_setnbr(int i)
{
	char	*num;
	int		len;
...
int	ft_format(char c, va_list var)
{
	g_c = 0;
	if (c == '%')
		g_c = ft_putchar('%');
